...
function PasswordView({ handleSubmit, handleNewPassword, handleNewPasswordConfirmChange, newPassword, newPasswordConfirm, goHome }) {
        ...
        <div className="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-12 shadow-lg backdrop-blur-md max-sm:px-8 mt-[-80px]">
          <div className="text-white text-center">
            <form onSubmit={handleSubmit}>
              <label className=" text-lg"> Ingrese la nueva Contraseña </label>
